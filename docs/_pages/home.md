...
header:
  ...
  caption:
intro:
  - excerpt: '<p><font size="6">Distribute FITS data with Apache Spark: Binary tables, images and more!</font></p><br /><small><a href="https://github.com/astrolabsoftware/spark-fits/releases/tag/0.5.0">Latest release v0.5.0</a></small>'
